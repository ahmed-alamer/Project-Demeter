...
class WalletsControllerTest < ActionController::TestCase
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post :create, wallet: { owner: @wallet.owner, public_address: @wallet.public_address, tag: @wallet.tag }
    end
  ...
  test "should update wallet" do
    patch :update, id: @wallet, wallet: { owner: @wallet.owner, public_address: @wallet.public_address, tag: @wallet.tag }
    assert_redirected_to wallet_path(assigns(:wallet))
  end
