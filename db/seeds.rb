ApprovalStatus.create!([
  ...
  {code: "R1", details: "Regection: Missing Generation or Claim Documents"},
...
Project.create!([
  {name: "Kathryn", nameplate: 4802, address: "0163 Melrose Pass", post_code: "9544", country: "FR", install_date: "2012-09-22", claimant_id: 11, status: 1},
  {name: "Frances", nameplate: 2659, address: "651 Reindahl Drive", post_code: "14831", country: "ID", install_date: "2014-07-14", claimant_id: 12, status: 0},
  {name: "Kelly", nameplate: 1845, address: "8030 Summit Junction", post_code: "17021", country: "ID", install_date: "2010-12-21", claimant_id: 17, status: 3},
  {name: "Denise", nameplate: 785, address: "1064 Lighthouse Bay Circle", post_code: "18962", country: "BR", install_date: "2010-08-28", claimant_id: 3, status: 1},
  {name: "Rebecca", nameplate: 1474, address: "062 Warner Trail", post_code: "7078", country: "PT", install_date: "2012-08-30", claimant_id: 9, status: 2},
  {name: "Cheryl", nameplate: 860, address: "18 Union Drive", post_code: "8186", country: "UA", install_date: "2012-10-09", claimant_id: 6, status: 0},
  {name: "Tammy", nameplate: 1665, address: "32 Thackeray Avenue", post_code: "10437", country: "RU", install_date: "2011-10-07", claimant_id: 13, status: 1},
  {name: "Denise", nameplate: 4677, address: "861 Union Parkway", post_code: "18300", country: "PH", install_date: "2012-03-11", claimant_id: 19, status: 1},
  {name: "Anne", nameplate: 3425, address: "097 Nancy Crossing", post_code: "12098", country: "CN", install_date: "2013-03-12", claimant_id: 6, status: 2},
  {name: "Mary", nameplate: 3212, address: "28155 Coolidge Circle", post_code: "6008", country: "PL", install_date: "2014-06-22", claimant_id: 4, status: 2},
  {name: "Frances", nameplate: 2789, address: "27 Mandrake Court", post_code: "14118", country: "PH", install_date: "2015-06-21", claimant_id: 8, status: 0},
  {name: "Irene", nameplate: 2299, address: "82865 Commercial Junction", post_code: "12308", country: "NG", install_date: "2012-12-17", claimant_id: 14, status: 0},
  {name: "Amanda", nameplate: 1149, address: "61 Eliot Center", post_code: "6462", country: "CN", install_date: "2011-12-08", claimant_id: 10, status: 1},
  {name: "Martha", nameplate: 3636, address: "00543 Gerald Park", post_code: "15752", country: "PH", install_date: "2011-07-23", claimant_id: 4, status: 3},
  {name: "Kathryn", nameplate: 1074, address: "5898 Prairie Rose Point", post_code: "8213", country: "GH", install_date: "2015-03-26", claimant_id: 15, status: 2},
  {name: "Janice", nameplate: 1167, address: "5333 Parkside Hill", post_code: "8409", country: "BR", install_date: "2013-03-25", claimant_id: 17, status: 2},
  {name: "Stephanie", nameplate: 2537, address: "92 Eggendart Parkway", post_code: "15976", country: "CN", install_date: "2013-03-06", claimant_id: 8, status: 2},
  {name: "Lois", nameplate: 2944, address: "7 Reinke Junction", post_code: "16692", country: "AM", install_date: "2011-09-26", claimant_id: 19, status: 1},
  {name: "Robin", nameplate: 4823, address: "38 Lukken Crossing", post_code: "2217", country: "SE", install_date: "2010-11-20", claimant_id: 11, status: 1},
  {name: "Martha", nameplate: 805, address: "7 Knutson Lane", post_code: "6972", country: "RU", install_date: "2013-05-26", claimant_id: 11, status: 1}
])
Wallet.create!([
